...
from .curves import generate_fbm_curve, generate_wm_curve, generate_takagi_curve

from .surfaces import generate_fbm_surface, generate_wm_surface, generate_takagi_surface
